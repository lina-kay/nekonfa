            ...
            if room_name in booked_slots:
                ...
                if isinstance(room_bookings, dict):
                    if slot_number in room_bookings:
                        ...
                        scheduled_topics.add(topic_title)  # Добавляем тему в scheduled_topics
                        topic_assigned = True
...
# Остальные функции остаются без изменений, но убедитесь, что они также корректны и работают правильно.
